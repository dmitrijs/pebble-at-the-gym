...
static void initialise_ui(void) {
    ...
    text_layer_set_text(s_textlayer_1, "Please wait while workouts are uploaded.");
...
void show_window_upload(void) {
    initialise_ui();
    progress_bar_layer_1 = progress_bar_layer_create(GRect(6, 65, 130, 8), (ProgressData) {.progress = 0, .maximum = 12});
    progress_bar_layer_2 = progress_bar_layer_create(GRect(6, 85, 130, 8), (ProgressData) {.progress = 0, .maximum = 12});
    progress_bar_layer_3 = progress_bar_layer_create(GRect(6, 105, 130, 8), (ProgressData) {.progress = 0, .maximum = 12});
